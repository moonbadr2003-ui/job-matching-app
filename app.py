...
def load_data():
    data = {
        '企業名': ['野村総研データ', 'SCSKデータ', 'NTTデータ'],
        '①年収・評価': [0.7799, 0.6673, 0.7937],
        '②成長・将来性': [0.648, 0.8742, 0.7993],
        '③キャリアアップ': [0.411, 0.3678, 0.3572],
        '④ワークライフバランス': [0.3937, 0.7533, 0.5604],
        '⑤福利厚生・環境': [0.8061, 0.7886, 0.8219],
        '⑥やりがい': [0.8553, 0.7657, 0.7838],
    }
